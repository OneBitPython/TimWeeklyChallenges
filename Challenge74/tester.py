...
# Name of file with inpu5ts test cases (and output if SEP_INP_OUT_TESTCASE_FILE is False)
...
def print_extra_stats(
    ...
    print(
        f" - Number of True cases: {yellow}{sum(1 if x == 'True' else 0 for x in test_out)}{reset}"
    )
